...
;(async () => {
  ...
  const hitbtc = new ccxt.hitbtc2 ({
        ...
        'apiKey': '7061789cb2cfa73c67b120ad80eac9de',
        'secret': '56b61d01ac5635488667d0066077fe2b',
        'verbose': false, // set to true to see more debugging output
        'timeout': 60000,
        'enableRateLimit': true, // add this
  ...
  try {
                          ...
                          for await (let pair of pairs) {
                            ...
                            try {
                              ...
                              }else if (pair.exchange ==="b_hbtc") {
                                t1 = "hitbtc";
                                t2 = "binance";
                                ticker1 =  await hitbtc.fetchTicker(pair.pair)
                                ticker2 = await binance.fetchTicker(pair.pair)
                                exchange_indicator = "HitBTC - Binance";
                              }else if (pair.exchange ==="o_hbtc") {
                                t1 = "okex";
                                t2 = "hitbtc";
                                ticker1 =  await okex.fetchTicker(pair.pair)
                                ticker2 = await hitbtc.fetchTicker(pair.pair)
                                exchange_indicator = "HitBTC - Okex";
                              }else if (pair.exchange ==="h_hbtc") {
                                t1 = "huobi";
                                t2 = "hitbtc";
                                ticker1 =  await huobi.fetchTicker(pair.pair)
                                ticker2 = await hitbtc.fetchTicker(pair.pair)
                                exchange_indicator = "Huobi - HitBTC";
                              }
